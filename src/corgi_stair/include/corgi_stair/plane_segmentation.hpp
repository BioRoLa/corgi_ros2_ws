...
public:
    ...
    // ROS 2: Pass tf_buffer as parameter instead of storing it
    void setInputCloud(pcl::PointCloud<PointT>::Ptr cloud, tf2_ros::Buffer *tf_buffer = nullptr);
    void computeNormals();
...
private:
    ...
    // Note: ROS publishers removed - calling nodes should handle visualization
