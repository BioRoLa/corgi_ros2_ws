...
// refer to example code: examples/example_utils.hpp
struct Utils{
...
// refer to example code: examples/CV7/CV7_example.cpp
...
class CX5_AHRS {
    public:
        ...
        void start() {
            ...
            float sensor_to_vehicle_transformation_euler[3] = {M_PI, 0, 0}; // M_PI, 0, 0
