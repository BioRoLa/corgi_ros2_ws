...
Note: zed-ros2-interfaces package is no longer needed when using ros2-humble or above, zed-msgs is automatically installed through 'sudo apt install ros-humble-zed-msgs'
