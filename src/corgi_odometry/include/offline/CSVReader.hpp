    ...
    public:
        ...
        std::vector<RobotData> read_csv(const std::string &filename)
        {
            ...
            while (std::getline(file, line))
            {
                ...
                // Optional ABAD channels (default 0 when missing)
                if (column_indices.count("state_gamma_a"))
                    row.state_gamma_a = values[column_indices.at("state_gamma_a")];
                if (column_indices.count("state_vel_h_a"))
                    row.state_vel_h_a = values[column_indices.at("state_vel_h_a")];
                if (column_indices.count("state_trq_h_a"))
                    row.state_trq_h_a = values[column_indices.at("state_trq_h_a")];

                if (column_indices.count("state_gamma_b"))
                    row.state_gamma_b = values[column_indices.at("state_gamma_b")];
                if (column_indices.count("state_vel_h_b"))
                    row.state_vel_h_b = values[column_indices.at("state_vel_h_b")];
                if (column_indices.count("state_trq_h_b"))
                    row.state_trq_h_b = values[column_indices.at("state_trq_h_b")];

                if (column_indices.count("state_gamma_c"))
                    row.state_gamma_c = values[column_indices.at("state_gamma_c")];
                if (column_indices.count("state_vel_h_c"))
                    row.state_vel_h_c = values[column_indices.at("state_vel_h_c")];
                if (column_indices.count("state_trq_h_c"))
                    row.state_trq_h_c = values[column_indices.at("state_trq_h_c")];

                if (column_indices.count("state_gamma_d"))
                    row.state_gamma_d = values[column_indices.at("state_gamma_d")];
                if (column_indices.count("state_vel_h_d"))
                    row.state_vel_h_d = values[column_indices.at("state_vel_h_d")];
                if (column_indices.count("state_trq_h_d"))
                    row.state_trq_h_d = values[column_indices.at("state_trq_h_d")];
