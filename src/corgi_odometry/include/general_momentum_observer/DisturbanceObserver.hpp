...
namespace corgi
{
    ...
    public:
         ...
         * @param dof Degrees of freedom (default: 16)
         ...
         * @param tau Control torque commands (actuated_dof,)
    ...
    private:
        ...
        int actuated_dof_;            // Number of actuated generalized inputs
         ...
         * - Legs: [beta, Rm, gamma] x 4 when dof >= 16
         * - Legs: [beta, Rm] x 4 when dof < 16
         */
